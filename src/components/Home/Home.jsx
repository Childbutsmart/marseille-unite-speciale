...
import { AppBar, Toolbar, IconButton, Drawer, List, ListItem, ListItemText, ListItemIcon, useMediaQuery, Box, Typography, Backdrop } from '@mui/material';
...
function Home() {
    ...
    return (
        <>
            <Box position="relative" width="100%" height="100vh" marginTop="-30px">
