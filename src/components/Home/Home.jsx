...
function Home() {
    ...
    const h1FontSize = isMobile ? '3rem' : '6rem'
    const h1StrokeWidth = isMobile ? '1px' : '3px'
        ...
        <Box position="relative" width="100%" minHeight="100vh" display="flex" flexDirection="column" alignItems="center" paddingBottom="100px">
            ...
            <Box 
                ...
                sx={{
                    ...
                    '& h1': {
                        fontWeight: 'bold', 
                        WebkitTextStrokeWidth: h1StrokeWidth, 
...
<Typography variant="h1">Portail Mondial de la Justice</Typography>
            ...
            <Box display="flex" flexDirection={isMobile ? 'column' : 'row'} justifyContent="space-between" alignItems="center" width="90%" marginTop="30px">
                <Box width={isMobile ? '100%' : '45%'}>
                    <img src="src/assets/img/Interpol.webp" alt="logo" style={{ width: '100%', height: 'auto', borderRadius: theme.shape.ofyou }} />
                </Box>
                <Box width={isMobile ? '100%' : '45%'} textAlign={isMobile ? 'center' : 'left'} padding={isMobile ? '20px' : '0 20px'}>
            ...
            <Box display="flex" flexDirection={isMobile ? 'column' : 'row'} justifyContent="space-between" alignItems="center" width="90%" marginTop="30px">
                <Box width={isMobile ? '100%' : '45%'} textAlign={isMobile ? 'center' : 'right'} padding={isMobile ? '20px' : '0 20px'}>
                    <Typography variant="body1">
...
En plus de la carte interactive, notre portail propose un formulaire de dénonciation anonyme. Si vous détenez des informations sur un criminel recherché, vous pouvez les partager en toute confidentialité en remplissant ce formulaire. Votre contribution peut être déterminante dans l'arrestation de criminels dangereux, contribuant ainsi à rendre le monde plus sûr pour tous.
                ...
                <Box width={isMobile ? '100%' : '45%'}>
                    <img src="src/assets/img/309622.webp" alt="arrestation" style={{ width: '100%', height: 'auto', borderRadius: theme.shape.ofyou }} />
                </Box>
            </Box>
            ...
            <Box display="flex" flexDirection={isMobile ? 'column' : 'row'} justifyContent="space-between" alignItems="center" width="90%" marginTop="30px">
                <Box width={isMobile ? '100%' : '45%'}>
                    <img src="src/assets/img/Training.jpg" alt="train" style={{ width: '100%', height: 'auto', borderRadius: theme.shape.ofyou }} />
                </Box>
                <Box width={isMobile ? '100%' : '45%'} textAlign={isMobile ? 'center' : 'left'} padding={isMobile ? '20px' : '0 20px'}>
                    <Typography variant="body1">
   ...
   Chaque type de notice émise par Interpol répond à des besoins spécifiques en matière de sécurité internationale et de lutte contre la criminalité, et elles sont diffusées aux agences d'application de la loi dans le monde entier pour faciliter la coopération et l'échange d'informations dans ces domaines.
                ...
                <Box width={isMobile ? '100%' : '45%'}>
                    <img src="src/assets/img/sayyou.jpg" alt="notice" style={{ width: '100%', height: 'auto', borderRadius: theme.shape.ofyou }} />
                </Box>
            </Box>
        </Box>
    );
